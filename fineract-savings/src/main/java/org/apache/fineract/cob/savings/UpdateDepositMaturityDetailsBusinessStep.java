...
public class UpdateDepositMaturityDetailsBusinessStep implements SavingsCOBBusinessStep {
    ...
    public SavingsAccount execute(SavingsAccount savingsAccount) {
        ...
        // Only fixed and recurring deposit accounts carry a maturity; plain savings deposits are skipped.
        if (depositAccountType != null && depositAccountType != DepositAccountType.SAVINGS_DEPOSIT) {
