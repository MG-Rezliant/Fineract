...
import static org.apache.fineract.command.audit.AuditCommandConstants.COMMAND_AUDIT_PROPERTY_HOOK_POST;
...
@ConditionalOnProperty(value = COMMAND_AUDIT_PROPERTY_HOOK_POST, havingValue = "true")
