...
import static org.apache.fineract.command.audit.AuditCommandConstants.COMMAND_AUDIT_PROPERTY_HOOK_PRE;
...
@ConditionalOnProperty(value = COMMAND_AUDIT_PROPERTY_HOOK_PRE, havingValue = "true")
