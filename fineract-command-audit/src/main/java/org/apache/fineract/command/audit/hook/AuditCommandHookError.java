...
import static org.apache.fineract.command.audit.AuditCommandConstants.COMMAND_AUDIT_PROPERTY_HOOK_ERROR;
...
@ConditionalOnProperty(value = COMMAND_AUDIT_PROPERTY_HOOK_ERROR, havingValue = "true")
