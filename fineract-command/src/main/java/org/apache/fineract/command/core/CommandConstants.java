...
public final class CommandConstants {
    ...
    public static final String COMMAND_PROPERTY_HOOKS_SERVLET_HEADER_PRE = COMMAND_PROPERTIES_PREFIX + ".hooks.servlet-header-pre";
    public static final String COMMAND_PROPERTY_HOOKS_TIMESTAMP_PRE = COMMAND_PROPERTIES_PREFIX + ".hooks.timestamp-pre";
    public static final String COMMAND_PROPERTY_HOOKS_USERNAME_PRE = COMMAND_PROPERTIES_PREFIX + ".hooks.username-pre";
