...
import static org.apache.fineract.command.core.CommandConstants.COMMAND_PROPERTY_HOOKS_TIMESTAMP_PRE;
...
@ConditionalOnProperty(value = COMMAND_PROPERTY_HOOKS_TIMESTAMP_PRE, havingValue = "true")
