...
/**
 * Thrown when a user who only holds the checker (`_CHECKER`) permission for a maker-checker enabled task -
 * without the base permission - attempts to initiate that task directly, instead of approving an existing
 * pending submission.
 */
