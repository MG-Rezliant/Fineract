...
/**
 * Thrown when a maker-only user submits a maker-checker enabled action for which a submission is already
 * awaiting checker approval for the same action, entity and resource.
 */
