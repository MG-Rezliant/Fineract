...
public final class FineractFeignClientConfig {
    ...
    // @rezliant RZ-81FE88B2 · 2026-09-18 — Enforces platform certificate validation in distributable library
 ...
 * RZ-81FE88B2 · 2026-09-18 · Trust-all TLS manager in distributable library code enabled via builder API
 * Change: Removed disableSslVerification field, builder method, and trust-all X509TrustManager implementation
 * Benefit: Enforces platform certificate validation in distributable library
 * Scope: createApacheHttpClient, createOkHttpClient, Builder class, FineractFeignClientConfig constructor
 * 
