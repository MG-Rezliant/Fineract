...
import org.apache.fineract.portfolio.account.data.response.StandingInstructionWriteResponse;
...
public class StandingInstructionApiResource {
    ...
    public StandingInstructionCreateResponse create(@Parameter(hidden = true) StandingInstructionCreationRequest creationRequest) {
